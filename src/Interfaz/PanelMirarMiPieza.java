...
public class PanelMirarMiPieza extends JFrame {
    ...
    private void buscarPieza() {
        String nombrePieza= campoIDPieza.getText();
        
        Pieza pieza=galeria.getInventario().buscarPieza(nombrePieza);
        ...
        if (nombrePieza.isEmpty()) {
            ...
            if (piezaEncontrada) {
            	...
            	if(pieza.isSubasta()) {
            		JOptionPane.showMessageDialog(this, "Información de la pieza:\nID: " + nombrePieza + "\n"+ "La pieza se esta subastando", "Pieza Encontrada", JOptionPane.INFORMATION_MESSAGE);
            	}else {
            		JOptionPane.showMessageDialog(this, "Información de la pieza:\nID: " + nombrePieza + "\n"+ "La pieza se esta Vendiendo", "Pieza Encontrada", JOptionPane.INFORMATION_MESSAGE);
            	}
            } else {
