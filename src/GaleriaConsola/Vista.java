...
public class Vista {
	...
	public void interfazPropietario(Galeria galeria, Usuario usuario) {
		...
		while(seguir) {
			...
			System.out.println("9.Mirar historia de un artista");
			System.out.println("10.Salir al menu pricipal");
			int input= scanner.nextInt();
			scanner.nextLine();
	...
	public void interfazAdmin(Galeria galeria, Usuario usuario) {
		...
		while(seguir) {
			...
			System.out.println("5.Mirar historia de un artista");
			System.out.println("6. Mirar la historia del comprador");
			System.out.println("7.Salir al menu pricipal");
			int input= scanner.nextInt();
			scanner.nextLine();
